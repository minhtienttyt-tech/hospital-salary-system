(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var e=`https://docs.google.com/spreadsheets/d/1Hv_suFrUYa5ZInJrYbOLkGCYwJv4A7w_YAyysgMZlAk/export?format=csv&gid=535447968`,t=`dashboard`,n=`05/2026`,r=`all`,i={},a={},o={},s={},c=`all`,l=[],u={},d=``,f=`monthly`,p=`q1`,m=null,h=`salary`,g=234e4,_=2026,v=null,y=new Set,b={},x={},S=155e5,C=62e5;try{i=JSON.parse(localStorage.getItem(`hospital_salary_data`))||{},a=JSON.parse(localStorage.getItem(`hospital_overtime_data`))||{},o=JSON.parse(localStorage.getItem(`hospital_bonus_data`))||{},s=JSON.parse(localStorage.getItem(`hospital_nq20_data`))||{},l=JSON.parse(localStorage.getItem(`hospital_salary_headers`))||[],u=JSON.parse(localStorage.getItem(`hospital_dependent_overrides`))||{},x=JSON.parse(localStorage.getItem(`hospital_budget_promotion_data`))||{};let e=!1;[a,o,s].forEach(t=>{Object.values(t).forEach(t=>{Array.isArray(t)&&t.forEach(t=>{t&&t.name&&/\([^)]+\)$/.test(t.name.trim())&&(t.name=t.name.replace(/\s*\([^)]+\)\s*$/,``),e=!0)})})}),e&&(localStorage.setItem(`hospital_overtime_data`,JSON.stringify(a)),localStorage.setItem(`hospital_bonus_data`,JSON.stringify(o)),localStorage.setItem(`hospital_nq20_data`,JSON.stringify(s)))}catch{i={},a={},o={},s={},l=[],u={},x={}}function w(){localStorage.setItem(`hospital_salary_data`,JSON.stringify(i)),localStorage.setItem(`hospital_overtime_data`,JSON.stringify(a)),localStorage.setItem(`hospital_bonus_data`,JSON.stringify(o)),localStorage.setItem(`hospital_nq20_data`,JSON.stringify(s)),localStorage.setItem(`hospital_salary_headers`,JSON.stringify(l)),localStorage.setItem(`hospital_dependent_overrides`,JSON.stringify(u)),localStorage.setItem(`hospital_budget_promotion_data`,JSON.stringify(x))}window.deleteNQ20Month=function(){let e=document.getElementById(`nq20-month-selector`)||document.getElementById(`month-selector`);e&&(n=e.value),confirm(`Xóa dữ liệu đãi ngộ NQ20 tháng `+n+`?`)&&(s[n]=[],w(),$())},window.deleteBonusMonth=function(){let e=document.getElementById(`bn-month-selector`)||document.getElementById(`month-selector`);e&&(n=e.value),c===`all`?confirm(`Xóa TẤT CẢ dữ liệu khen thưởng tháng `+n+`?`)&&(delete o[n],w(),$()):confirm(`Xóa dữ liệu "`+c+`" của tháng `+n+`?`)&&(o[n]=o[n].filter(e=>e.content!==c),c=`all`,w(),$())},window.deleteOTMonth=function(){let e=document.getElementById(`ot-month-selector`)||document.getElementById(`month-selector`);e&&(n=e.value),confirm(`Xóa dữ liệu ngoài giờ tháng `+n+`?`)&&(delete a[n],w(),$())},window.deleteMonth=function(){let e=document.getElementById(`month-selector`);if(e&&(n=e.value),confirm(`Bạn có chắc chắn muốn xóa dữ liệu lương tháng `+n+`?`)){delete i[n];let e=O(Object.keys(i));n=e.length?e[0]:`05/2026`,w(),$()}};var T=e=>{if(!e||!e.name)return!1;let t=String(e.name).trim();return t.length>3&&isNaN(t)&&/[a-zA-ZÀ-ỹ]/.test(t)&&!t.startsWith(`Tổng`)};function E(e){if(typeof e==`number`)return e;if(!e)return 0;let t=e.toString().trim(),n=/^-/.test(t)?-1:1,r=t.replace(/[^\d]/g,``);return n*(parseInt(r)||0)}function D(e){if(typeof e==`number`)return e;if(!e)return 0;let t=e.toString().trim().replace(`,`,`.`);return parseFloat(t)||0}function O(e){return e.sort((e,t)=>{let[n=0,r=0]=String(e).split(`/`).map(Number),[i=0,a=0]=String(t).split(`/`).map(Number);return a*12+i-(r*12+n)})}function k(e,t=``){try{if(!e)return``;let n=e.trim(),r=n.match(/\/d\/(.*?)(\/|$)/);if(!r)return n;let i=`https://docs.google.com/spreadsheets/d/${r[1]}/export?format=csv`;if(t)i+=`&gid=${t}`;else{let e=n.match(/gid=([\d]+)/);e&&(i+=`&gid=${e[1]}`)}return i}catch{return e}}function A(e){return(e||0).toLocaleString(`vi-VN`)}function j(e){let t=Papa.parse(e,{skipEmptyLines:!0}).data,n=t.findIndex(e=>e.some(e=>e&&(e.toString().trim()===`TT`||e.toString().trim()===`STT`)));n===-1&&(n=6),l=t[n]?t[n].map(e=>e.toString().trim()):[];let r=[];for(let e=n+1;e<t.length;e++){let n=t[e];if(n.some(e=>e&&(e.toString().toLowerCase().includes(`tổng cộng`)||e.toString().toLowerCase()===`cộng`)))break;let i=String(n[1]||``).trim();if(!T({name:i}))continue;let a={base:n[4],area:n[5],vkhung:n[6],position:n[7],responsibility:n[8],incentive:n[9],toxic:n[10],party:n[11]},o=[E(n[13]),E(n[14]),E(n[15]),E(n[16]),E(n[17]),E(n[18]),E(n[19]),E(n[20]),E(n[21]),E(n[22]),E(n[23]),E(n[24]),E(n[25]),E(n[26]),E(n[27]),E(n[28]),E(n[29]),E(n[30]),E(n[31])];r.push({id:String(n[0]||``).trim(),name:i,department:String(n[2]||``).trim(),position:String(n[3]||``).trim(),coefficients:a,rawAmounts:o,numDependents:E(n[27])||0,total:o[8]||0,net:o[18]||0})}return r}function M(e,t=``){let n=Papa.parse(e,{skipEmptyLines:!0}).data;if(n.length<2)return[];let r=n.findIndex(e=>e.some(e=>e&&e.toString().toLowerCase().includes(`họ và tên`)));r===-1&&(r=0);let i=-1;n[r]&&(i=n[r].findIndex(e=>e&&e.toString().toLowerCase().includes(`nội dung`)));let a=[];for(let e=r+1;e<n.length;e++){let r=n[e];if(r.some(e=>e&&(e.toString().toLowerCase().includes(`tổng cộng`)||e.toString().toLowerCase()===`cộng`)))break;let o=r[1]?.toString().trim();!o||o===``||/^[IVXLCDM]+\./.test(o)||o.split(` `).length<2&&isNaN(o)===!1||(o=o.replace(/\s*\([^)]+\)\s*$/,``),a.push({name:o,amount:E(r[4]),content:i===-1?t:r[i]?.toString().trim()||t}))}return a}async function N(){if(i[n]&&i[n].length>0){$();return}$();try{let t=j(await(await fetch(k(e))).text());t.length&&(i[n]=t,w())}catch(e){console.error(e)}finally{$()}}var P=()=>`
  ...
  </header>`,R=()=>{let e=[],t=``;if(f===`monthly`){let r=(i[n]||[]).filter(T);e=d?r.filter(e=>e.name.toLowerCase().includes(d.toLowerCase())||e.department.toLowerCase().includes(d.toLowerCase())):r,t=`Bảng lương `+n}else{let n=I(p);e=F(i,n),t=`Tổng hợp Lương `+(p===`all`?`Cả năm`:`Quý `+p[1])}let r=O(Object.keys(i));return`
  <div class="fade-in">
    ${L(t)}
    <div class="card">
  ...
  </div>`},V=()=>{let e=[],t=``;if(f===`monthly`){let r=o[n]||[],i=r;c!==`all`&&(i=r.filter(e=>e.content===c)),e=d?i.filter(e=>e.name.toLowerCase().includes(d.toLowerCase())):i,t=`Danh sách Khen thưởng ${n}`}else{let n=I(p),r=F(o,n);e=d?r.filter(e=>e.name.toLowerCase().includes(d.toLowerCase())):r,t=`Tổng hợp Khen thưởng `+(p===`all`?`Cả năm`:`Quý `+p[1])}let r=O(Object.keys(o));return`
  <div class="fade-in">
    ${L(t)}
    <div class="card">
      <div style="display:flex;justify-content:space-between;margin-bottom:1.5rem;gap:1rem;flex-wrap:wrap;">
  ...
  </div>`},H=()=>{let e=[],t=``;if(f===`monthly`){let r=a[n]||[];e=d?r.filter(e=>e.name.toLowerCase().includes(d.toLowerCase())):r,t=`Trực & Ngoài giờ ${n}`}else{let n=I(p),r=F(a,n);e=d?r.filter(e=>e.name.toLowerCase().includes(d.toLowerCase())):r,t=`Tổng hợp Ngoài giờ `+(p===`all`?`Cả năm`:`Quý `+p[1])}let r=O(Object.keys(a));return`
  <div class="fade-in">
    ${L(t)}
    <div class="card">
      <div style="display:flex;justify-content:space-between;margin-bottom:1.5rem;gap:1rem;flex-wrap:wrap;">
