(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var e=`https://docs.google.com/spreadsheets/d/1Hv_suFrUYa5ZInJrYbOLkGCYwJv4A7w_YAyysgMZlAk/export?format=csv&gid=535447968`,t=`dashboard`,n=`05/2026`,r=`all`,i={},a={},o={},s=[],c={},l=``,u=`monthly`,d=`q1`,f=null,p=`salary`,m=234e4,h=2026,g=155e5,_=62e5;try{i=JSON.parse(localStorage.getItem(`hospital_salary_data`))||{},a=JSON.parse(localStorage.getItem(`hospital_overtime_data`))||{},o=JSON.parse(localStorage.getItem(`hospital_bonus_data`))||{},s=JSON.parse(localStorage.getItem(`hospital_salary_headers`))||[],c=JSON.parse(localStorage.getItem(`hospital_dependent_overrides`))||{}}catch{i={},a={},o={},s=[],c={}}function v(){localStorage.setItem(`hospital_salary_data`,JSON.stringify(i)),localStorage.setItem(`hospital_overtime_data`,JSON.stringify(a)),localStorage.setItem(`hospital_bonus_data`,JSON.stringify(o)),localStorage.setItem(`hospital_salary_headers`,JSON.stringify(s)),localStorage.setItem(`hospital_dependent_overrides`,JSON.stringify(c))}window.deleteBonusMonth=function(){let e=document.getElementById(`bn-month-selector`)||document.getElementById(`month-selector`);e&&(n=e.value),console.log(`Attempting to delete Bonus for:`,n),confirm(`Xóa dữ liệu khen thưởng tháng `+n+`?`)&&(delete o[n],v(),H(),console.log(`Bonus deleted successfully`))},window.deleteOTMonth=function(){let e=document.getElementById(`ot-month-selector`)||document.getElementById(`month-selector`);e&&(n=e.value),confirm(`Xóa dữ liệu ngoài giờ tháng `+n+`?`)&&(delete a[n],v(),H())},window.deleteMonth=function(){let e=document.getElementById(`month-selector`);if(e&&(n=e.value),confirm(`Bạn có chắc chắn muốn xóa dữ liệu lương tháng `+n+`?`)){delete i[n];let e=S(Object.keys(i));n=e.length?e[0]:`05/2026`,v(),H()}};var y=e=>{if(!e||!e.name)return!1;let t=String(e.name).trim();return t.length>3&&isNaN(t)&&/[a-zA-ZÀ-ỹ]/.test(t)&&!t.startsWith(`Tổng`)};function b(e){if(typeof e==`number`)return e;if(!e)return 0;let t=e.toString().trim(),n=/^-/.test(t)?-1:1,r=t.replace(/[^\d]/g,``);return n*(parseInt(r)||0)}function x(e){if(typeof e==`number`)return e;if(!e)return 0;let t=e.toString().trim().replace(`,`,`.`);return parseFloat(t)||0}function S(e){return e.sort((e,t)=>{let[n=0,r=0]=String(e).split(`/`).map(Number),[i=0,a=0]=String(t).split(`/`).map(Number);return a*12+i-(r*12+n)})}function C(e,t=``){try{if(!e)return``;let n=e.trim(),r=n.match(/\/d\/(.*?)(\/|$)/);if(!r)return n;let i=`https://docs.google.com/spreadsheets/d/${r[1]}/export?format=csv`;if(t)i+=`&gid=${t}`;else{let e=n.match(/gid=([\d]+)/);e&&(i+=`&gid=${e[1]}`)}return i}catch{return e}}function w(e){return(e||0).toLocaleString(`vi-VN`)}function T(e){let t=Papa.parse(e,{skipEmptyLines:!0}).data,n=t.findIndex(e=>e.some(e=>e&&(e.toString().trim()===`TT`||e.toString().trim()===`STT`)));n===-1&&(n=6),s=t[n]?t[n].map(e=>e.toString().trim()):[];let r=[];for(let e=n+1;e<t.length;e++){let n=t[e],i=String(n[1]||``).trim();if(!y({name:i}))continue;let a={base:n[4],area:n[5],vkhung:n[6],position:n[7],responsibility:n[8],incentive:n[9],toxic:n[10],party:n[11]},o=[b(n[13]),b(n[14]),b(n[15]),b(n[16]),b(n[17]),b(n[18]),b(n[19]),b(n[20]),b(n[21]),b(n[22]),b(n[23]),b(n[24]),b(n[25]),b(n[26]),b(n[27]),b(n[28]),b(n[29]),b(n[30]),b(n[31])];r.push({id:String(n[0]||``).trim(),name:i,department:String(n[2]||``).trim(),position:String(n[3]||``).trim(),coefficients:a,rawAmounts:o,numDependents:b(n[27])||0,total:o[8]||0,net:o[18]||0})}return r}function E(e){let t=Papa.parse(e,{skipEmptyLines:!0}).data;if(t.length<2)return[];let n=t.findIndex(e=>e.some(e=>e&&e.toString().toLowerCase().includes(`họ và tên`)));n===-1&&(n=0);let r=Array(t[n].length).fill(``);for(let e=0;e<=n;e++)t[e].forEach((e,t)=>{e&&(r[t]+=` `+e.toString().toLowerCase())});let i=r.findIndex(e=>e.includes(`họ và tên`)),a=r.findIndex(e=>e.includes(`tiền thưởng`)||e.includes(`tổng số`)||e.includes(`thực lĩnh`));a===-1&&(a=8),i===-1&&(i=1);let o=r.findIndex(e=>e.includes(`khoa`)||e.includes(`phòng`)||e.includes(`đơn vị`)),s=r.findIndex(e=>e.includes(`nội dung`)||e.includes(`ghi chú`)),c=[];for(let e=n+1;e<t.length;e++){let n=t[e],r=n[i]?.toString().trim();!r||r===``||r.toLowerCase().includes(`tổng cộng`)||/^[IVXLCDM]+\./.test(r)||r.split(` `).length<2&&isNaN(r)===!1||c.push({name:r,dept:o===-1?``:n[o]?.toString().trim(),amount:b(n[a]),content:s===-1?`Thưởng NĐ73`:n[s]?.toString().trim()})}return c}async function D(){if(i[n]&&i[n].length>0){H();return}H();try{let t=T(await(await fetch(`https://corsproxy.io/?${encodeURIComponent(C(e))}`)).text());t.length&&(i[n]=t,v())}catch(e){console.error(e)}finally{H()}}var O=()=>`
  <aside class="sidebar">
  ...
  </header>`,M=()=>{let e=[],t=``;if(u===`monthly`){let r=(i[n]||[]).filter(y);e=l?r.filter(e=>e.name.toLowerCase().includes(l.toLowerCase())||e.department.toLowerCase().includes(l.toLowerCase())):r,t=`Bảng lương `+n}else{let n=A(d);e=k(i,n),t=`Tổng hợp Lương `+(d===`all`?`Cả năm`:`Quý `+d[1])}let r=S(Object.keys(i));return`
  <div class="fade-in">
    ${j(t)}
    <div class="card">
        ...
        <table class="salary-detail-table">
          ...
          <tbody>
            ${e.map(e=>`<tr>
              ...
              ${(e.rawAmounts||Array(19).fill(0)).map((e,t)=>`<td class="${t===8?`highlight-total`:t===18?`highlight-col`:``}">${w(e)}</td>`).join(``)}
            </tr>`).join(``)}
          </tbody>
        </table>
      </div>
    </div>
  </div>`},N=()=>{let e=[`Lương chính`,`PC vượt khung`,`PC Khu vực`,`PC Chức vụ`,`PC Trách nhiệm`,`PC ưu đãi ngành`,`PC Độc hại`,`PC cấp ủy`,`Tổng cộng lương`,`Khấu trừ 10,5% BH`,`KT 10,5% BH CV`,`KT 10,5% BH VK`,`Trừ ốm LC`,`Trừ ốm VK`,`Trừ ốm CV`,`Trừ ốm TN`,`Trừ ốm ƯĐ`,`Trừ ốm ĐH`,`Tổng lĩnh`],t={};Object.entries(i).forEach(([e,n])=>{if(!Array.isArray(n))return;let i=parseInt(e.split(`/`)[0]);r!==`all`&&r!==(i<=3?`1`:i<=6?`2`:i<=9?`3`:`4`)||n.filter(y).forEach(n=>{t[n.name]||(t[n.name]={name:n.name,dept:n.department,monthsInPeriod:0,rawAmounts:Array(19).fill(0),otAmount:0,bonusAmount:0,numDependents:c[n.name]===void 0?n.numDependents||0:c[n.name]}),t[n.name].monthsInPeriod+=1,n.rawAmounts&&n.rawAmounts.forEach((e,r)=>t[n.name].rawAmounts[r]=(t[n.name].rawAmounts[r]||0)+(e||0));let r=(a[e]||[]).find(e=>e.name===n.name);t[n.name].otAmount+=r?r.amount:0;let i=(o[e]||[]).find(e=>e.name===n.name);t[n.name].bonusAmount+=i?i.amount:0})});let n=Object.values(t).map(e=>{let t=e.rawAmounts[8]+e.otAmount+e.bonusAmount,n=e.monthsInPeriod*g,r=e.monthsInPeriod*(e.numDependents*_),i=(e.rawAmounts[9]||0)+(e.rawAmounts[10]||0)+(e.rawAmounts[11]||0),a=t-i-n-r;return{...e,gross_taxable:t,gt_bt:n,gt_npt:r,taxable:a,insurance:i}}).sort((e,t)=>t.taxable-e.taxable),s=l?n.filter(e=>e.name.toLowerCase().includes(l.toLowerCase())):n;return`
  <div class="fade-in">
    ${j(`Thuế TNCN - Tổng hợp số liệu `+(r===`all`?`Cả năm`:`Quý ${r}`))}
    <div class="card">
        ...
        <table class="salary-detail-table" style="font-size:0.82rem;">
          ...
          <tbody>
            ${s.map((e,t)=>`<tr>
              ...
              ${e.rawAmounts.map((e,t)=>`<td class="${t===8?`highlight-total`:t===18?`highlight-col`:``}">${w(e)}</td>`).join(``)}
              <td style="background:rgba(14, 165, 233, 0.05);">${w(e.otAmount)}</td>
              <td style="background:rgba(14, 165, 233, 0.05);">${w(e.bonusAmount)}</td>
              <td class="highlight-col" style="font-weight:700;color:var(--primary);">${w(e.taxable>0?e.taxable:0)}</td>
  ...
  </div>`},P=()=>{let e=[],t=``;if(u===`monthly`){let r=o[n]||[];e=l?r.filter(e=>e.name.toLowerCase().includes(l.toLowerCase())):r,t=`Danh sách Khen thưởng ${n}`}else{let n=A(d),r=k(o,n);e=l?r.filter(e=>e.name.toLowerCase().includes(l.toLowerCase())):r,t=`Tổng hợp Khen thưởng `+(d===`all`?`Cả năm`:`Quý `+d[1])}let r=S(Object.keys(o));return`
  <div class="fade-in">
    ${j(t)}
    <div class="card">
      <div style="display:flex;justify-content:space-between;margin-bottom:1.5rem;gap:1rem;flex-wrap:wrap;">
      ...
      <div class="table-container">
        <table class="salary-detail-table">
          ...
          <tbody>
            ${e.length>0?e.map((e,t)=>`<tr><td>${t+1}</td><td>${e.name}</td><td>${e.dept||``}</td><td>${e.content||``}</td><td class="highlight-total">${w(e.amount)}</td></tr>`).join(``):`<tr><td colspan="5" style="text-align:center;padding:3rem;color:var(--text-muted);">Chưa có dữ liệu khen thưởng tháng ${n}.<br><br><button class="btn btn-primary" onclick="document.getElementById('import-bonus-btn').click()">Import ngay</button></td></tr>`}
          </tbody>
        </table>
      </div>
    </div>
  </div>`},F=()=>{let e=[],t=``;if(u===`monthly`){let r=a[n]||[];e=l?r.filter(e=>e.name.toLowerCase().includes(l.toLowerCase())):r,t=`Trực & Ngoài giờ ${n}`}else{let n=A(d),r=k(a,n);e=l?r.filter(e=>e.name.toLowerCase().includes(l.toLowerCase())):r,t=`Tổng hợp Ngoài giờ `+(d===`all`?`Cả năm`:`Quý `+d[1])}let r=S(Object.keys(a));return`
  <div class="fade-in">
    ${j(t)}
    <div class="card">
      <div style="display:flex;justify-content:space-between;margin-bottom:1.5rem;gap:1rem;flex-wrap:wrap;">
      ...
      <div class="table-container" style="max-height:650px;">
        <table class="salary-detail-table">
          ...
          <tbody>${e.map((e,t)=>`<tr><td>${t+1}</td><td>${e.name}</td><td>${w(e.amount)}</td></tr>`).join(``)}</tbody>
        </table>
      </div>
    </div>
  </div>`};function I(e){let t=Papa.parse(e,{skipEmptyLines:!0}).data,n=[];for(let e=1;e<t.length;e++){let r=t[e];r[1]&&n.push({name:r[1].trim(),amount:b(r[10]||r[20])})}return n}var L=()=>{let e=(i[n]||[]).filter(y),t=a[n]||[],r=o[n]||[],s=e.reduce((e,t)=>e+t.total,0),c=t.reduce((e,t)=>e+(t.amount||0),0),l=r.reduce((e,t)=>e+(t.amount||0),0),u=s+c+l;return`
  <div class="fade-in">
    ${j(`Tổng quan `+n)}
    <div class="stats-grid">
      <div class="card stat-card"><span class="stat-label">Tổng quỹ lương</span><span class="stat-value">${w(u)}</span></div>
      <div class="card stat-card"><span class="stat-label">Tổng Trực & Ngoài giờ</span><span class="stat-value">${w(c)}</span></div>
      <div class="card stat-card"><span class="stat-label">Tổng Khen thưởng</span><span class="stat-value">${w(l)}</span></div>
    </div>
  </div>`},R=()=>{let e=(i[n]||[]).filter(y),t={base:0,cv:0,kv:0,vk:0,tn:0,dh:0,ud56:0,sumPc:0,bhxh:0,bhyt:0,bhtn:0,kpcd:0,sumIns:0,totalCoef:0,thanhTien:0,chiThuong:0,tongCong:0},r=e.map((e,n)=>{let r=x(e.coefficients?.base),i=x(e.coefficients?.position),a=x(e.coefficients?.area),o=x(e.coefficients?.vkhung),s=x(e.coefficients?.responsibility),c=x(e.coefficients?.toxic),l=x(e.coefficients?.incentive),u=i+a+o+s+c+l+0+0+0,d=r+i+o,f=d*.175,p=d*.03,h=d*.01,g=d*.02,_=f+p+h+g,v=r+u+_,y=Math.round(v*m),b=Math.round(r*m*.1),S=y+b;return t.base+=r,t.cv+=i,t.kv+=a,t.vk+=o,t.tn+=s,t.dh+=c,t.ud56+=l,t.sumPc+=u,t.bhxh+=f,t.bhyt+=p,t.bhtn+=h,t.kpcd+=g,t.sumIns+=_,t.totalCoef+=v,t.thanhTien+=y,t.chiThuong+=b,t.tongCong+=S,`<tr>
      <td class="sticky-col col-tt">${n+1}</td>
      <td class="sticky-col col-name" style="font-weight:600;">${e.name}</td>
      <td class="sticky-col col-dept">${e.department||``}</td>
      <td class="text-center">${r.toFixed(2).replace(`.`,`,`)}</td>
      ...
      <td class="text-center">${s?s.toFixed(2).replace(`.`,`,`):``}</td><td class="text-center">${c?c.toFixed(2).replace(`.`,`,`):``}</td><td class="text-center">${l?l.toFixed(2).replace(`.`,`,`):``}</td>
      <td class="text-center"></td><td class="text-center"></td><td class="text-center"></td>
      <td class="text-center" style="font-weight:600;background:#f8fafc;">${u?u.toFixed(2).replace(`.`,`,`):``}</td>
      <td class="text-center">${f.toFixed(3).replace(`.`,`,`)}</td><td class="text-center">${p.toFixed(3).replace(`.`,`,`)}</td><td class="text-center">${h.toFixed(3).replace(`.`,`,`)}</td><td class="text-center">${g.toFixed(3).replace(`.`,`,`)}</td>
      <td class="text-center" style="font-weight:600;color:var(--danger);">${_.toFixed(3).replace(`.`,`,`)}</td>
      <td class="text-center" style="font-weight:600;color:var(--primary);">${v.toFixed(3).replace(`.`,`,`)}</td>
      <td class="highlight-total">${w(y)}</td>
      <td style="background:rgba(234, 179, 8, 0.05); text-align:right;">${w(b)}</td>
      <td class="highlight-col">${w(S)}</td>
    </tr>`}).join(``);return`
    <div style="margin-bottom:1rem; display:flex; justify-content:space-between; align-items:center;">
      <p style="font-style:italic; color:var(--text-muted); margin:0;">(Dữ liệu phóng chiếu từ bảng lương tháng ${n})</p>
    ...
    <div class="table-container" style="max-height:600px; overflow-x:auto;">
      <table class="salary-detail-table" style="min-width: 1800px; font-size:0.8rem;">
        ...
        <tbody>${e.length?r:`<tr><td colspan="23" style="text-align:center;padding:2rem;">Không có dữ liệu, vui lòng Import bảng lương trước.</td></tr>`}</tbody>
        ${e.length?`<tfoot>
          <tr style="font-weight:700;background:var(--card-bg);border-top:2px solid var(--accent);">
            <td colspan="3" class="sticky-col" style="text-align:center;">Tổng cộng</td>
            <td class="text-center">${t.base.toFixed(2).replace(`.`,`,`)}</td>
            <td class="text-center">${t.cv.toFixed(2).replace(`.`,`,`)}</td><td class="text-center">${t.kv.toFixed(2).replace(`.`,`,`)}</td><td class="text-center">${t.vk.toFixed(2).replace(`.`,`,`)}</td>
            <td class="text-center">${t.tn.toFixed(2).replace(`.`,`,`)}</td><td class="text-center">${t.dh.toFixed(2).replace(`.`,`,`)}</td><td class="text-center">${t.ud56.toFixed(2).replace(`.`,`,`)}</td>
            <td></td><td></td><td></td>
            <td class="text-center">${t.sumPc.toFixed(2).replace(`.`,`,`)}</td>
            <td class="text-center">${t.bhxh.toFixed(2).replace(`.`,`,`)}</td><td class="text-center">${t.bhyt.toFixed(2).replace(`.`,`,`)}</td><td class="text-center">${t.bhtn.toFixed(2).replace(`.`,`,`)}</td><td class="text-center">${t.kpcd.toFixed(2).replace(`.`,`,`)}</td>
            <td class="text-center">${t.sumIns.toFixed(2).replace(`.`,`,`)}</td><td class="text-center">${t.totalCoef.toFixed(2).replace(`.`,`,`)}</td>
            <td class="highlight-total">${w(t.thanhTien)}</td><td style="text-align:right;">${w(t.chiThuong)}</td><td class="highlight-col">${w(t.tongCong)}</td>
          </tr>
        </tfoot>`:``}
      </table>
    </div>
  `},z=()=>{let e=(i[n]||[]).filter(y),t=0,r=0,a=0,o=e.length;return e.forEach(e=>{let n=x(e.coefficients?.base),i=x(e.coefficients?.position)+x(e.coefficients?.area)+x(e.coefficients?.vkhung)+x(e.coefficients?.responsibility)+x(e.coefficients?.toxic)+x(e.coefficients?.incentive),o=(n+x(e.coefficients?.position)+x(e.coefficients?.vkhung))*.235;t+=n,r+=i,a+=o}),`
    <div style="padding: 1rem 0;">
      <h3 style="margin-bottom:1rem;color:var(--primary);">Tổng hợp hệ số bình quân</h3>
      <table class="salary-detail-table" style="max-width: 800px; margin: 0 auto;">
        <thead>
          <tr><th>Chỉ tiêu</th><th style="text-align:center;">Số lượng/Hệ số</th></tr>
        </thead>
        <tbody>
          <tr><td style="font-weight:600;">Tổng số cán bộ, viên chức</td><td style="text-align:center;font-size:1.1rem;font-weight:700;">${o} <small style="font-weight:400;color:var(--text-muted);">người</small></td></tr>
          <tr><td style="font-weight:600;">Hệ số bình quân</td><td style="text-align:center;font-size:1.1rem;font-weight:700;color:var(--primary);">${o?((t+r+a)/o).toFixed(2).replace(`.`,`,`):0}</td></tr>
          <tr><td style="padding-left:2rem;">- Hệ số Lương chính bình quân</td><td style="text-align:center;">${o?(t/o).toFixed(2).replace(`.`,`,`):0}</td></tr>
          <tr><td style="padding-left:2rem;">- Hệ số Phụ cấp bình quân</td><td style="text-align:center;">${o?(r/o).toFixed(2).replace(`.`,`,`):0}</td></tr>
          <tr><td style="padding-left:2rem;">- Hệ số các khoản đóng góp bình quân</td><td style="text-align:center;">${o?(a/o).toFixed(2).replace(`.`,`,`):0}</td></tr>
        </tbody>
      </table>
    </div>
  `},B=()=>{let e=(i[n]||[]).filter(y),t=0,r=0;return e.forEach(e=>{let n=x(e.coefficients?.base),i=x(e.coefficients?.position)+x(e.coefficients?.area)+x(e.coefficients?.vkhung)+x(e.coefficients?.responsibility)+x(e.coefficients?.toxic)+x(e.coefficients?.incentive),a=(n+x(e.coefficients?.position)+x(e.coefficients?.vkhung))*.235;t+=Math.round((n+i+a)*m*12),r+=Math.round(n*m*.1*12)}),`
    <div style="padding: 1rem 0;">
      <div style="display:flex; justify-content:space-between; margin-bottom:1rem;">
        <h3 style="color:var(--primary); margin:0;">Mẫu xây dựng dự toán năm ${h}</h3>
        <button class="btn btn-secondary" onclick="window.print()"><i data-lucide="printer" size="16"></i> In Biểu</button>
      </div>
      <div class="table-container">
        <table class="salary-detail-table" style="font-size:0.9rem;">
          <thead>
            <tr><th style="width:50px;">STT</th><th>Nội dung chi</th><th style="width:200px;text-align:right;">Dự toán ${h} (VNĐ)</th></tr>
          </thead>
          <tbody>
            <tr style="background:rgba(14, 165, 233, 0.1);"><td style="font-weight:700;">I</td><td style="font-weight:700;">Quỹ lương, phụ cấp và các khoản đóng góp</td><td style="text-align:right;font-weight:700;color:var(--primary);">${w(t)}</td></tr>
            <tr><td>1</td><td>Quỹ lương, phụ cấp (12 tháng)</td><td style="text-align:right;">${w(t)}</td></tr>
            <tr style="background:rgba(14, 165, 233, 0.1);"><td style="font-weight:700;">II</td><td style="font-weight:700;">Kinh phí chi thưởng NĐ 73 (10% quỹ lương cơ bản)</td><td style="text-align:right;font-weight:700;color:var(--primary);">${w(r)}</td></tr>
            <tr style="background:rgba(14, 165, 233, 0.1);"><td style="font-weight:700;">III</td><td style="font-weight:700;">Chi hoạt động thường xuyên (Nhập thủ công)</td><td style="text-align:right;font-weight:700;"></td></tr>
            <tr><td>1</td><td>Phụ cấp trực</td><td style="text-align:right;padding:0;"><input type="number" class="select-input" style="width:100%;text-align:right;border:none;border-radius:0;" placeholder="Nhập số tiền..."></td></tr>
            <tr><td>2</td><td>Tiền thủ thuật - phẫu thuật</td><td style="text-align:right;padding:0;"><input type="number" class="select-input" style="width:100%;text-align:right;border:none;border-radius:0;" placeholder="Nhập số tiền..."></td></tr>
            <tr><td>3</td><td>Thanh toán tiền điện, nước, nhiên liệu</td><td style="text-align:right;padding:0;"><input type="number" class="select-input" style="width:100%;text-align:right;border:none;border-radius:0;" placeholder="Nhập số tiền..."></td></tr>
            <tr><td>4</td><td>Vật tư y tế, Hóa chất, Tiền máu</td><td style="text-align:right;padding:0;"><input type="number" class="select-input" style="width:100%;text-align:right;border:none;border-radius:0;" placeholder="Nhập số tiền..."></td></tr>
            <tr><td>5</td><td>Các khoản chi thường xuyên khác</td><td style="text-align:right;padding:0;"><input type="number" class="select-input" style="width:100%;text-align:right;border:none;border-radius:0;" placeholder="Nhập số tiền..."></td></tr>
          </tbody>
        </table>
      </div>
    </div>
  ...
  `,t=``;return p===`salary`?t=R():p===`coefficients`?t=z():p===`template`&&(t=B()),`
  <div class="fade-in">
    ${j(`Dự toán năm `+h)}
    <div class="card">
  ...
  </div>`},H=()=>{let s=document.getElementById(`app`);if(s)try{let u=``;switch(t){case`salary`:u=M();break;case`pit`:u=N();break;case`overtime`:u=F();break;case`bonus`:u=P();break;case`budget`:u=V();break;default:u=L()}s.innerHTML=`${O()}<main class="main-content">${u}</main>
      ...
      </div>`,lucide.createIcons(),document.querySelectorAll(`.nav-item[data-tab]`).forEach(e=>e.onclick=()=>{t=e.dataset.tab,H()});let f=document.getElementById(`search-input`);f&&(f.value=l,f.oninput=e=>{l=e.target.value,H()});let p=document.getElementById(`month-selector`)||document.getElementById(`ot-month-selector`)||document.getElementById(`bn-month-selector`);p&&(p.onchange=e=>{n=e.target.value,H()});let m=document.getElementById(`pit-quarter-selector`);m&&(m.onchange=e=>{r=e.target.value,H()}),document.querySelectorAll(`.npt-input`).forEach(e=>{e.onchange=e=>{let t=e.target.dataset.name,n=parseInt(e.target.value)||0;c[t]=n,v(),H()}});let h=document.getElementById(`import-btn`),g=document.getElementById(`import-modal`),_=document.getElementById(`close-modal`),y=document.getElementById(`confirm-import`);_&&(_.onclick=()=>g.style.display=`none`),y&&(y.onclick=async()=>{let e=document.getElementById(`import-month-name`).value.trim(),t=document.getElementById(`import-url`).value.trim(),r=document.getElementById(`import-gid`).value.trim(),s=y.getAttribute(`data-type`)||`salary`;if(!e||!t)return alert(`Thiếu thông tin`);y.textContent=`Đang xử lý...`,y.disabled=!0;try{let c=C(t,r),l=await(await fetch(`https://corsproxy.io/?${encodeURIComponent(c)}`)).text();if(s===`salary`){let t=T(l);if(!t.length)throw Error(`Dữ liệu không hợp lệ`);i[e]=t}else if(s===`bonus`){let t=E(l);if(!t.length)throw Error(`Dữ liệu không hợp lệ`);o[e]=t}else{let t=I(l);if(!t.length)throw Error(`Dữ liệu không hợp lệ`);a[e]=t}n=e,v(),g.style.display=`none`,H()}catch(e){alert(`Lỗi: `+e.message)}finally{y.textContent=`Bắt đầu Import`,y.disabled=!1}});let b=document.getElementById(`import-ot-btn`),x=document.getElementById(`import-bonus-btn`);b&&(b.onclick=()=>{document.getElementById(`import-title`).textContent=`Import Ngoài giờ`,document.getElementById(`import-url`).value=`https://docs.google.com/spreadsheets/d/1d4VhrIM_lk8BeODjG2_PCAK85NXOVI6aLQO1XlUjyiU/edit`,document.getElementById(`import-gid`).value=`2041249704`,y.setAttribute(`data-type`,`overtime`),g.style.display=`flex`}),h&&(h.onclick=()=>{document.getElementById(`import-title`).textContent=`Import Lương`,document.getElementById(`import-url`).value=localStorage.getItem(`last_salary_url`)||e,document.getElementById(`import-gid`).value=localStorage.getItem(`last_salary_gid`)||``,y.setAttribute(`data-type`,`salary`),g.style.display=`flex`}),x&&(x.onclick=()=>{document.getElementById(`import-title`).textContent=`Import Khen thưởng`,document.getElementById(`import-url`).value=localStorage.getItem(`last_bonus_url`)||`https://docs.google.com/spreadsheets/d/1Imhhn8uEhS2_Wn_3TbQlohsrEUUai_EK6JVJfNUDboQ/edit`,document.getElementById(`import-gid`).value=localStorage.getItem(`last_bonus_gid`)||`1464193880`,y.setAttribute(`data-type`,`bonus`),g.style.display=`flex`});let S=document.getElementById(`summary-period-selector`),w=document.getElementById(`ot-period-selector`),D=document.getElementById(`bn-period-selector`);S&&(S.onchange=e=>{d=e.target.value,r=e.target.value.replace(`q`,``),H()}),w&&(w.onchange=e=>{d=e.target.value,r=e.target.value.replace(`q`,``),H()}),D&&(D.onchange=e=>{d=e.target.value,r=e.target.value.replace(`q`,``),H()});let k=document.getElementById(`close-preview`);k&&(k.onclick=()=>document.getElementById(`preview-modal`).style.display=`none`);let A=document.getElementById(`theme-toggle`);A&&(A.onclick=()=>{document.body.setAttribute(`data-theme`,document.body.getAttribute(`data-theme`)===`dark`?`light`:`dark`)}),s.onclick=e=>{let t=e.target.closest(`button`);!t||!t.id||(t.id===`delete-bonus-btn`?(e.preventDefault(),window.deleteBonusMonth()):t.id===`delete-ot-btn`?(e.preventDefault(),window.deleteOTMonth()):t.id===`delete-salary-btn`&&(e.preventDefault(),window.deleteMonth()))}}catch(e){s.innerHTML=`<div style="padding:3rem;text-align:center;"><h2>Sự cố hiển thị</h2><button class="btn btn-primary" onclick="window.emergencyReset()">Khôi phục hệ thống</button><pre style="text-align:left;margin-top:2rem;">${e.stack}</pre></div>`}};window.setViewMode=e=>{u=e,H()},window.setBudgetTab=e=>{p=e,H()},window.updateBudgetBaseSalary=e=>{m=parseInt(e.target.value)||234e4,H()},window.exportBudgetToExcel=function(e){if(e===`salary`){let e=document.querySelector(`.salary-detail-table`);if(!e)return alert(`Không tìm thấy bảng!`);let t=XLSX.utils.table_to_book(e,{sheet:`DuToan_BangLuong`});XLSX.writeFile(t,`Bang_Luong_Du_Toan_${h}.xlsx`)}},window.exportSalaryToExcel=function(){try{let e=(i[n]||[]).filter(y);if(!e.length)return alert(`Không có dữ liệu để xuất!`);let t=[`Lương chính`,`PC vượt khung`,`PC Khu vực`,`PC Chức vụ`,`PC Trách nhiệm`,`PC ưu đãi ngành`,`PC Độc hại`,`PC cấp ủy`,`Tổng cộng lương`,`Khấu trừ 10,5% BH`,`KT 10,5% BH CV`,`KT 10,5% BH VK`,`Trừ ốm LC`,`Trừ ốm VK`,`Trừ ốm CV`,`Trừ ốm TN`,`Trừ ốm ƯĐ`,`Trừ ốm ĐH`,`Tổng lĩnh`],r=e.map(e=>{let n={TT:e.id,"Họ tên":e.name,"Khoa/Phòng":e.department,"Chức vụ":e.position,HSL:e.coefficients?.base,KV:e.coefficients?.area,VK:e.coefficients?.vkhung,CV:e.coefficients?.position,TN:e.coefficients?.responsibility,ƯĐ:e.coefficients?.incentive,ĐH:e.coefficients?.toxic,CU:e.coefficients?.party};return t.forEach((t,r)=>{n[t]=(e.rawAmounts||[])[r]||0}),n}),a=XLSX.utils.json_to_sheet(r),o=XLSX.utils.book_new();XLSX.utils.book_append_sheet(o,a,`Bang Luong`),XLSX.writeFile(o,`Bang_Luong_${n.replace(`/`,`-`)}.xlsx`)}catch(e){console.error(`Excel Export Error:`,e),alert(`Lỗi khi xuất Excel: `+e.message)}},window.exportSalaryToPDF=function(){try{let e=document.querySelector(`.salary-detail-table`);if(!e)return alert(`Không tìm thấy bảng dữ liệu!`);let t=document.createElement(`div`);t.style.padding=`20px`,t.style.background=`#fff`,t.innerHTML=`
  ...
  `;let i=e.cloneNode(!0);i.style.width=`100%`,i.style.fontSize=`10px`,n.appendChild(i);let a={margin:[10,5,10,5],filename:`Thue_TNCN_${t.replace(` `,`_`)}.pdf`,image:{type:`jpeg`,quality:.98},html2canvas:{scale:2,useCORS:!0,letterRendering:!0},jsPDF:{unit:`mm`,format:`a4`,orientation:`landscape`}};html2pdf().set(a).from(n).save()},window.showReportPreview=function(e){let t=document.getElementById(`preview-modal`),s=document.getElementById(`preview-container`);if(!t||!s)return;let l=``,p=``,m=``,h=new Date,v=`Than Uyên, ngày ${h.getDate()} tháng ${h.getMonth()+1} năm ${h.getFullYear()}`;if(e===`salary`){let e=u===`summary`,t=e?d===`all`?`CẢ NĂM 2026`:`QUÝ ${d[1]}/2026`:`THÁNG ${n}`;l=`BẢNG ${e?`TỔNG HỢP`:`THANH TOÁN`} LƯƠNG NHÂN VIÊN`,p=t;let r=e?k(i,A(d)):(i[n]||[]).filter(y);m=`
      <table class="report-table">
        ...
        <tbody>
          ${r.map(t=>`<tr>
            ...
            ${(t.rawAmounts||[]).map(e=>`<td>${w(e)}</td>`).join(``)}
          </tr>`).join(``)}
        </tbody>
        <tfoot>
          <tr>
            <td colspan="${e?4:3}">TỔNG CỘNG</td>
            ${Array(19).fill(0).map((e,t)=>`<td>${w(r.reduce((e,n)=>e+(n.rawAmounts?.[t]||0),0))}</td>`).join(``)}
          </tr>
        </tfoot>
      </table>
    `}else if(e===`bonus`){let e=u===`summary`,t=e?d===`all`?`CẢ NĂM 2026`:`QUÝ ${d[1]}/2026`:`THÁNG ${n}`;l=`BẢNG TỔNG HỢP TIỀN KHEN THƯỞNG`,p=t;let r=e?A(d):[n],i={};r.forEach(e=>{(o[e]||[]).forEach(e=>{i[e.name]||(i[e.name]={...e,amount:0,months_count:0}),i[e.name].amount+=e.amount||0,i[e.name].months_count++})});let a=Object.values(i);m=`
      <table class="report-table">
        <thead>
          <tr>
            <th>TT</th><th>Họ và tên</th><th>Bộ phận</th>
      ...
      <table class="report-table">
        ...
        <tbody>
          ${o.map((t,n)=>`<tr>
            <td>${n+1}</td><td>${t.name}</td><td>${t.dept||``}</td>
            ${e?`<td>${t.months_count}</td>`:``}
            <td>${w(t.salary)}</td><td>${w(t.hourly)}</td>
            <td>${w(t.m150)}</td><td>${w(t.m200)}</td><td>${w(t.m300)}</td>
            <td style="font-weight:700;">${w(t.amount)}</td>
          </tr>`).join(``)}
        </tbody>
        <tfoot>
          <tr>
            <td colspan="${e?5:4}">TỔNG CỘNG</td>
            <td>${w(o.reduce((e,t)=>e+(t.m150||0),0))}</td>
            <td>${w(o.reduce((e,t)=>e+(t.m200||0),0))}</td>
            <td>${w(o.reduce((e,t)=>e+(t.m300||0),0))}</td>
            <td style="font-weight:700;">${w(o.reduce((e,t)=>e+(t.amount||0),0))}</td>
          </tr>
        </tfoot>
      </table>
    `}else if(e===`pit`){let e=r===`all`?`CẢ NĂM 2026`:`QUÝ ${r}/2026`;l=`BẢNG KÊ THU NHẬP TÍNH THUẾ THU NHẬP CÁ NHÂN`,p=e;let t=[`Lương chính`,`PC vượt khung`,`PC Khu vực`,`PC Chức vụ`,`PC Trách nhiệm`,`PC ưu đãi ngành`,`PC Độc hại`,`PC cấp ủy`,`Tổng lương`,`BH 10.5%`,`BH CV`,`BH VK`,`Trừ ốm LC`,`Trừ ốm VK`,`Trừ ốm CV`,`Trừ ốm TN`,`Trừ ốm ƯĐ`,`Trừ ốm ĐH`,`Thực lĩnh`],n={};Object.entries(i).forEach(([e,t])=>{let i=parseInt(e.split(`/`)[0]);r!==`all`&&r!==(i<=3?`1`:i<=6?`2`:i<=9?`3`:`4`)||t.filter(y).forEach(t=>{n[t.name]||(n[t.name]={name:t.name,dept:t.department,months:0,rawAmounts:Array(19).fill(0),otAmount:0}),n[t.name].months++,t.rawAmounts&&t.rawAmounts.forEach((e,r)=>n[t.name].rawAmounts[r]+=e||0);let r=(a[e]||[]).find(e=>e.name===t.name);n[t.name].otAmount+=r?r.amount:0})});let o=Object.values(n);m=`
      <table class="report-table">
        ...
        <tbody>
          ${o.map(e=>{let t=e.rawAmounts[8]+e.otAmount,n=(e.rawAmounts[9]||0)+(e.rawAmounts[10]||0)+(e.rawAmounts[11]||0),r=c[e.name]||0,i=t-n-e.months*(g+r*_);return`<tr>
              <td>${e.name}</td><td>${e.dept}</td>
              ${e.rawAmounts.slice(0,9).map(e=>`<td>${w(e)}</td>`).join(``)}
              <td>${w(e.otAmount)}</td>
              <td>${w(i>0?i:0)}</td>
            </tr>`}).join(``)}
        </tbody>
