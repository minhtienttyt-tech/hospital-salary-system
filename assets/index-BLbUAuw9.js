        ...
        <table class="salary-detail-table">
          <thead>
            <tr>
              <th>STT</th>
              <th>Họ tên</th>
              <th>Nội dung ${d===`monthly`?`<button onclick="window.copyDownBonusContent()" title="Sao chép nội dung từ hàng 1 xuống toàn bộ" style="cursor:pointer;background:none;border:none;margin-left:0.5rem;">⬇️</button>`:``}</th>
              <th>Số tiền</th>
            </tr>
          </thead>
          <tbody>
