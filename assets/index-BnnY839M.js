(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var e=`https://docs.google.com/spreadsheets/d/1Hv_suFrUYa5ZInJrYbOLkGCYwJv4A7w_YAyysgMZlAk/export?format=csv&gid=535447968`,t=`dashboard`,n=`05/2026`,r=`all`,i={},a={},o={},s={},c=[],l={},u=``,d=`monthly`,f=`q1`,p=null,m=`salary`,h=234e4,g=2026,_=null,v=new Set,y={},b=155e5,x=62e5;try{i=JSON.parse(localStorage.getItem(`hospital_salary_data`))||{},a=JSON.parse(localStorage.getItem(`hospital_overtime_data`))||{},o=JSON.parse(localStorage.getItem(`hospital_bonus_data`))||{},s=JSON.parse(localStorage.getItem(`hospital_nq20_data`))||{},c=JSON.parse(localStorage.getItem(`hospital_salary_headers`))||[],l=JSON.parse(localStorage.getItem(`hospital_dependent_overrides`))||{}}catch{i={},a={},o={},s={},c=[],l={}}function S(){localStorage.setItem(`hospital_salary_data`,JSON.stringify(i)),localStorage.setItem(`hospital_overtime_data`,JSON.stringify(a)),localStorage.setItem(`hospital_bonus_data`,JSON.stringify(o)),localStorage.setItem(`hospital_nq20_data`,JSON.stringify(s)),localStorage.setItem(`hospital_salary_headers`,JSON.stringify(c)),localStorage.setItem(`hospital_dependent_overrides`,JSON.stringify(l))}window.deleteNQ20Month=function(){let e=document.getElementById(`nq20-month-selector`)||document.getElementById(`month-selector`);e&&(n=e.value),confirm(`Xóa dữ liệu đãi ngộ NQ20 tháng `+n+`?`)&&(delete s[n],S(),J())},window.deleteBonusMonth=function(){let e=document.getElementById(`bn-month-selector`)||document.getElementById(`month-selector`);e&&(n=e.value),console.log(`Attempting to delete Bonus for:`,n),confirm(`Xóa dữ liệu khen thưởng tháng `+n+`?`)&&(delete o[n],S(),J(),console.log(`Bonus deleted successfully`))},window.deleteOTMonth=function(){let e=document.getElementById(`ot-month-selector`)||document.getElementById(`month-selector`);e&&(n=e.value),confirm(`Xóa dữ liệu ngoài giờ tháng `+n+`?`)&&(delete a[n],S(),J())},window.deleteMonth=function(){let e=document.getElementById(`month-selector`);if(e&&(n=e.value),confirm(`Bạn có chắc chắn muốn xóa dữ liệu lương tháng `+n+`?`)){delete i[n];let e=E(Object.keys(i));n=e.length?e[0]:`05/2026`,S(),J()}};var C=e=>{if(!e||!e.name)return!1;let t=String(e.name).trim();return t.length>3&&isNaN(t)&&/[a-zA-ZÀ-ỹ]/.test(t)&&!t.startsWith(`Tổng`)};function w(e){if(typeof e==`number`)return e;if(!e)return 0;let t=e.toString().trim(),n=/^-/.test(t)?-1:1,r=t.replace(/[^\d]/g,``);return n*(parseInt(r)||0)}function T(e){if(typeof e==`number`)return e;if(!e)return 0;let t=e.toString().trim().replace(`,`,`.`);return parseFloat(t)||0}function E(e){return e.sort((e,t)=>{let[n=0,r=0]=String(e).split(`/`).map(Number),[i=0,a=0]=String(t).split(`/`).map(Number);return a*12+i-(r*12+n)})}function D(e,t=``){try{if(!e)return``;let n=e.trim(),r=n.match(/\/d\/(.*?)(\/|$)/);if(!r)return n;let i=`https://docs.google.com/spreadsheets/d/${r[1]}/export?format=csv`;if(t)i+=`&gid=${t}`;else{let e=n.match(/gid=([\d]+)/);e&&(i+=`&gid=${e[1]}`)}return i}catch{return e}}function O(e){return(e||0).toLocaleString(`vi-VN`)}function k(e){let t=Papa.parse(e,{skipEmptyLines:!0}).data,n=t.findIndex(e=>e.some(e=>e&&(e.toString().trim()===`TT`||e.toString().trim()===`STT`)));n===-1&&(n=6),c=t[n]?t[n].map(e=>e.toString().trim()):[];let r=[];for(let e=n+1;e<t.length;e++){let n=t[e],i=String(n[1]||``).trim();if(!C({name:i}))continue;let a={base:n[4],area:n[5],vkhung:n[6],position:n[7],responsibility:n[8],incentive:n[9],toxic:n[10],party:n[11]},o=[w(n[13]),w(n[14]),w(n[15]),w(n[16]),w(n[17]),w(n[18]),w(n[19]),w(n[20]),w(n[21]),w(n[22]),w(n[23]),w(n[24]),w(n[25]),w(n[26]),w(n[27]),w(n[28]),w(n[29]),w(n[30]),w(n[31])];r.push({id:String(n[0]||``).trim(),name:i,department:String(n[2]||``).trim(),position:String(n[3]||``).trim(),coefficients:a,rawAmounts:o,numDependents:w(n[27])||0,total:o[8]||0,net:o[18]||0})}return r}function A(e){let t=Papa.parse(e,{skipEmptyLines:!0}).data;if(t.length<2)return[];let n=t.findIndex(e=>e.some(e=>e&&e.toString().toLowerCase().includes(`họ và tên`)));n===-1&&(n=0);let r=Array(t[n].length).fill(``);for(let e=0;e<=n;e++)t[e].forEach((e,t)=>{e&&(r[t]+=` `+e.toString().toLowerCase())});let i=r.findIndex(e=>e.includes(`họ và tên`)),a=r.findIndex(e=>e.includes(`tiền thưởng`)||e.includes(`tổng số`)||e.includes(`thực lĩnh`));a===-1&&(a=8),i===-1&&(i=1);let o=r.findIndex(e=>e.includes(`khoa`)||e.includes(`phòng`)||e.includes(`đơn vị`)),s=r.findIndex(e=>e.includes(`nội dung`)||e.includes(`ghi chú`)),c=[];for(let e=n+1;e<t.length;e++){let n=t[e],r=n[i]?.toString().trim();!r||r===``||r.toLowerCase().includes(`tổng cộng`)||/^[IVXLCDM]+\./.test(r)||r.split(` `).length<2&&isNaN(r)===!1||c.push({name:r,dept:o===-1?``:n[o]?.toString().trim(),amount:w(n[a]),content:s===-1?`Thưởng NĐ73`:n[s]?.toString().trim()})}return c}async function j(){if(i[n]&&i[n].length>0){J();return}J();try{let t=k(await(await fetch(`https://corsproxy.io/?${encodeURIComponent(D(e))}`)).text());t.length&&(i[n]=t,S())}catch(e){console.error(e)}finally{J()}}var M=()=>`
    ...
    <div class="card">
      <div style="display:flex;justify-content:space-between;margin-bottom:1.5rem;gap:1rem;flex-wrap:wrap;">
        ...
        <div style="display:flex;gap:0.5rem;align-items:center;">
          ...
          ${d===`monthly`?`<button class="btn btn-secondary" onclick="window.addNewNQ20Doctor()"><i data-lucide="plus" size="16"></i> Thêm cá nhân</button>`:``}
      ...
      <div class="table-container" style="max-height:650px;">
        <table class="salary-detail-table">
          ...
          <tbody>
            ${e.length>0?e.map((e,t)=>{if(d===`monthly`){let n=t=>t===`TS_CKII`&&e.amount===2e6||t===`THS_CKI_BSNT`&&e.amount===15e5||t===`BS_TYT_DBKK`&&e.amount===12e5||t===`BS_TYT`&&e.amount===1e6||e.categoryKey===t?`selected`:``,r=[2e6,15e5,12e5,1e6].includes(e.amount),i=!r&&!e.categoryKey||e.categoryKey===`CUSTOM`;return`
                    <tr>
                      <td>${t+1}</td>
                      ...
                      <td>
                        <select class="select-input" onchange="window.updateNQ20Category('${e.name}', this.value)" style="width:100%;font-size:0.85rem;padding:4px 8px;">
                          <option value="TS_CKII" ${n(`TS_CKII`)}>Tiến sĩ / Bác sĩ CKII (2,0M)</option>
                          <option value="THS_CKI_BSNT" ${n(`THS_CKI_BSNT`)}>Thạc sĩ / BSCKI / BS Nội trú (1,5M)</option>
                          <option value="BS_TYT_DBKK" ${n(`BS_TYT_DBKK`)}>Bác sĩ TYT xã ĐBKK (1,2M)</option>
                          <option value="BS_TYT" ${n(`BS_TYT`)}>Bác sĩ Trạm y tế / PKĐKKV (1,0M)</option>
                          <option value="CUSTOM" ${i?`selected`:``}>Khác (Tùy chỉnh số tiền)</option>
                        </select>
                      </td>
                      <td>
                      ...
                      <td>
                        <input type="number" class="select-input" value="${e.amount}" onchange="window.updateNQ20Amount('${e.name}', this.value)" style="width:120px;text-align:right;font-size:0.85rem;padding:2px 6px;" ${!i&&r?`disabled`:``}>
                      </td>
                    ...
                    </tr>`}).join(``):`<tr><td colspan="${d===`monthly`?7:5}" style="text-align:center;padding:3rem;color:var(--text-muted);">Chưa có dữ liệu đãi ngộ NQ20 tháng ${n}.<br><br><div style="display:flex;gap:0.5rem;justify-content:center;"><button class="btn btn-primary" onclick="window.initializeNQ20FromSalary()">Khởi tạo từ Bảng lương</button><button class="btn btn-secondary" onclick="document.getElementById('import-nq20-btn').click()">Import ngay</button></div></td></tr>`}
          </tbody>
        </table>
      </div>
    </div>
  </div>`};function V(e){let t=Papa.parse(e,{skipEmptyLines:!0}).data,n=[];for(let e=1;e<t.length;e++){let r=t[e];r[1]&&n.push({name:r[1].trim(),amount:w(r[10]||r[20])})}return n}function H(e){let t=Papa.parse(e,{skipEmptyLines:!0}).data;if(t.length<2)return[];let n=t.findIndex(e=>e.some(e=>e&&e.toString().toLowerCase().includes(`họ và tên`)));n===-1&&(n=0);let r=Array(t[n].length).fill(``);for(let e=0;e<=n;e++)t[e].forEach((e,t)=>{e&&(r[t]+=` `+e.toString().toLowerCase())});let i=r.findIndex(e=>e.includes(`họ và tên`)),a=r.findIndex(e=>e.includes(`tiền`)||e.includes(`đối tượng`)||e.includes(`đãi ngộ`)||e.includes(`tổng số`)||e.includes(`thực lĩnh`)||e.includes(`hỗ trợ`));a===-1&&(a=8),i===-1&&(i=1);let o=r.findIndex(e=>e.includes(`khoa`)||e.includes(`phòng`)||e.includes(`đơn vị`)||e.includes(`bộ phận`)),s=r.findIndex(e=>e.includes(`đối tượng`)||e.includes(`phân loại`)||e.includes(`trình độ`)||e.includes(`nghị quyết`)),c=[];for(let e=n+1;e<t.length;e++){let n=t[e],r=n[i]?.toString().trim();!r||r===``||r.toLowerCase().includes(`tổng cộng`)||/^[IVXLCDM]+\./.test(r)||r.split(` `).length<2&&isNaN(r)===!1||c.push({name:r,dept:o===-1?``:n[o]?.toString().trim(),category:s===-1?`Đãi ngộ NQ20`:n[s]?.toString().trim(),amount:w(n[a])})}return c}var U=()=>{let e=(i[n]||[]).filter(C),t=a[n]||[],r=o[n]||[],c=s[n]||[],l=e.reduce((e,t)=>e+t.total,0),u=t.reduce((e,t)=>e+(t.amount||0),0),d=r.reduce((e,t)=>e+(t.amount||0),0),f=c.reduce((e,t)=>e+(t.amount||0),0),p=l+u+d+f;return`
  <div class="fade-in">
    ${F(`Tổng quan `+n)}
  ...
  </div>`},J=()=>{let c=document.getElementById(`app`);if(c)try{let d=``;switch(t){case`salary`:d=I();break;case`pit`:d=L();break;case`overtime`:d=z();break;case`bonus`:d=R();break;case`nq20`:d=B();break;case`budget`:d=q();break;default:d=U()}c.innerHTML=`${M()}<main class="main-content">${d}</main>
  ...
  `;let i=e.cloneNode(!0);i.style.width=`100%`,i.style.fontSize=`10px`,n.appendChild(i);let a={margin:[10,5,10,5],filename:`Thue_TNCN_${t.replace(` `,`_`)}.pdf`,image:{type:`jpeg`,quality:.98},html2canvas:{scale:2,useCORS:!0,letterRendering:!0},jsPDF:{unit:`mm`,format:`a4`,orientation:`landscape`}};html2pdf().set(a).from(n).save()},window.showReportPreview=function(e){let t=document.getElementById(`preview-modal`),c=document.getElementById(`preview-container`);if(!t||!c)return;let u=``,m=``,h=``,g=new Date,_=`Than Uyên, ngày ${g.getDate()} tháng ${g.getMonth()+1} năm ${g.getFullYear()}`;if(e===`salary`){let e=d===`summary`,t=e?f===`all`?`CẢ NĂM 2026`:`QUÝ ${f[1]}/2026`:`THÁNG ${n}`;u=`BẢNG ${e?`TỔNG HỢP`:`THANH TOÁN`} LƯƠNG NHÂN VIÊN`,m=t;let r=e?N(i,P(f)):(i[n]||[]).filter(C);h=`
    ...
    `}else if(e===`nq20`){let e=d===`summary`,t=e?f===`all`?`CẢ NĂM 2026`:`QUÝ ${f[1]}/2026`:`THÁNG ${n}`;u=`BẢNG TỔNG HỢP CHI TRẢ ĐÃI NGỘ NQ20`,m=t;let r=e?P(f):[n],i={};r.forEach(e=>{(s[e]||[]).forEach(e=>{i[e.name]||(i[e.name]={...e,amount:0,months_count:0}),i[e.name].amount+=e.amount||0,i[e.name].months_count++})});let a=Object.values(i);h=`
      <table class="report-table">
        <thead>
          <tr>
            <th>TT</th><th>Họ và tên</th><th>Bộ phận</th>
        ...
        <tbody>
          ${a.map((t,n)=>`<tr>
            <td>${n+1}</td><td>${t.name}</td><td>${t.dept||``}</td>
            ${e?`<td>${t.months_count}</td>`:``}
            <td>${t.category||t.categoryKey||`Đãi ngộ NQ20`}</td>
            <td>${t.content||t.notes||``}</td>
            <td style="font-weight:700;">${O(t.amount)}</td>
          </tr>`).join(``)}
        </tbody>
        <tfoot>
          <tr>
            <td colspan="${e?6:5}">TỔNG CỘNG</td>
            <td style="font-weight:700;">${O(a.reduce((e,t)=>e+(t.amount||0),0))}</td>
          </tr>
        </tfoot>
      </table>
