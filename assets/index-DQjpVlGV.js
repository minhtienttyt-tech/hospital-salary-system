(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var e=`https://docs.google.com/spreadsheets/d/1Hv_suFrUYa5ZInJrYbOLkGCYwJv4A7w_YAyysgMZlAk/export?format=csv&gid=535447968`,t=`dashboard`,n=`05/2026`,r=`all`,i={},a={},o={},s={},c=[],l={},u=``,d=`monthly`,f=`q1`,p=null,m=`salary`,h=234e4,g=2026,_=null,v=new Set,y={},b=155e5,x=62e5;try{i=JSON.parse(localStorage.getItem(`hospital_salary_data`))||{},a=JSON.parse(localStorage.getItem(`hospital_overtime_data`))||{},o=JSON.parse(localStorage.getItem(`hospital_bonus_data`))||{},s=JSON.parse(localStorage.getItem(`hospital_nq20_data`))||{},c=JSON.parse(localStorage.getItem(`hospital_salary_headers`))||[],l=JSON.parse(localStorage.getItem(`hospital_dependent_overrides`))||{};let e=!1;[a,o,s].forEach(t=>{Object.values(t).forEach(t=>{Array.isArray(t)&&t.forEach(t=>{t&&t.name&&/\([^)]+\)$/.test(t.name.trim())&&(t.name=t.name.replace(/\s*\([^)]+\)\s*$/,``),e=!0)})})}),e&&(localStorage.setItem(`hospital_overtime_data`,JSON.stringify(a)),localStorage.setItem(`hospital_bonus_data`,JSON.stringify(o)),localStorage.setItem(`hospital_nq20_data`,JSON.stringify(s)))}catch{i={},a={},o={},s={},c=[],l={}}function S(){localStorage.setItem(`hospital_salary_data`,JSON.stringify(i)),localStorage.setItem(`hospital_overtime_data`,JSON.stringify(a)),localStorage.setItem(`hospital_bonus_data`,JSON.stringify(o)),localStorage.setItem(`hospital_nq20_data`,JSON.stringify(s)),localStorage.setItem(`hospital_salary_headers`,JSON.stringify(c)),localStorage.setItem(`hospital_dependent_overrides`,JSON.stringify(l))}window.deleteNQ20Month=function(){let e=document.getElementById(`nq20-month-selector`)||document.getElementById(`month-selector`);e&&(n=e.value),confirm(`Xóa dữ liệu đãi ngộ NQ20 tháng `+n+`?`)&&(s[n]=[],S(),X())},window.deleteBonusMonth=function(){let e=document.getElementById(`bn-month-selector`)||document.getElementById(`month-selector`);e&&(n=e.value),console.log(`Attempting to delete Bonus for:`,n),confirm(`Xóa dữ liệu khen thưởng tháng `+n+`?`)&&(delete o[n],S(),X(),console.log(`Bonus deleted successfully`))},window.deleteOTMonth=function(){let e=document.getElementById(`ot-month-selector`)||document.getElementById(`month-selector`);e&&(n=e.value),confirm(`Xóa dữ liệu ngoài giờ tháng `+n+`?`)&&(delete a[n],S(),X())},window.deleteMonth=function(){let e=document.getElementById(`month-selector`);if(e&&(n=e.value),confirm(`Bạn có chắc chắn muốn xóa dữ liệu lương tháng `+n+`?`)){delete i[n];let e=E(Object.keys(i));n=e.length?e[0]:`05/2026`,S(),X()}};var C=e=>{if(!e||!e.name)return!1;let t=String(e.name).trim();return t.length>3&&isNaN(t)&&/[a-zA-ZÀ-ỹ]/.test(t)&&!t.startsWith(`Tổng`)};function w(e){if(typeof e==`number`)return e;if(!e)return 0;let t=e.toString().trim(),n=/^-/.test(t)?-1:1,r=t.replace(/[^\d]/g,``);return n*(parseInt(r)||0)}function T(e){if(typeof e==`number`)return e;if(!e)return 0;let t=e.toString().trim().replace(`,`,`.`);return parseFloat(t)||0}function E(e){return e.sort((e,t)=>{let[n=0,r=0]=String(e).split(`/`).map(Number),[i=0,a=0]=String(t).split(`/`).map(Number);return a*12+i-(r*12+n)})}function D(e,t=``){try{if(!e)return``;let n=e.trim(),r=n.match(/\/d\/(.*?)(\/|$)/);if(!r)return n;let i=`https://docs.google.com/spreadsheets/d/${r[1]}/export?format=csv`;if(t)i+=`&gid=${t}`;else{let e=n.match(/gid=([\d]+)/);e&&(i+=`&gid=${e[1]}`)}return i}catch{return e}}function O(e){return(e||0).toLocaleString(`vi-VN`)}function k(e){let t=Papa.parse(e,{skipEmptyLines:!0}).data,n=t.findIndex(e=>e.some(e=>e&&(e.toString().trim()===`TT`||e.toString().trim()===`STT`)));n===-1&&(n=6),c=t[n]?t[n].map(e=>e.toString().trim()):[];let r=[];for(let e=n+1;e<t.length;e++){let n=t[e];if(n.some(e=>e&&(e.toString().toLowerCase().includes(`tổng cộng`)||e.toString().toLowerCase()===`cộng`)))break;let i=String(n[1]||``).trim();if(!C({name:i}))continue;let a={base:n[4],area:n[5],vkhung:n[6],position:n[7],responsibility:n[8],incentive:n[9],toxic:n[10],party:n[11]},o=[w(n[13]),w(n[14]),w(n[15]),w(n[16]),w(n[17]),w(n[18]),w(n[19]),w(n[20]),w(n[21]),w(n[22]),w(n[23]),w(n[24]),w(n[25]),w(n[26]),w(n[27]),w(n[28]),w(n[29]),w(n[30]),w(n[31])];r.push({id:String(n[0]||``).trim(),name:i,department:String(n[2]||``).trim(),position:String(n[3]||``).trim(),coefficients:a,rawAmounts:o,numDependents:w(n[27])||0,total:o[8]||0,net:o[18]||0})}return r}function A(e){let t=Papa.parse(e,{skipEmptyLines:!0}).data;if(t.length<2)return[];let n=t.findIndex(e=>e.some(e=>e&&e.toString().toLowerCase().includes(`họ và tên`)));n===-1&&(n=0);let r=Array(t[n].length).fill(``);for(let e=0;e<=n;e++)t[e].forEach((e,t)=>{e&&(r[t]+=` `+e.toString().toLowerCase())});let i=r.findIndex(e=>e.includes(`họ và tên`)),a=r.findIndex(e=>e.includes(`tiền thưởng`)||e.includes(`tổng số`)||e.includes(`thực lĩnh`));a===-1&&(a=8),i===-1&&(i=1);let o=r.findIndex(e=>e.includes(`khoa`)||e.includes(`phòng`)||e.includes(`đơn vị`)),s=r.findIndex(e=>e.includes(`nội dung`)||e.includes(`ghi chú`)),c=[];for(let e=n+1;e<t.length;e++){let n=t[e];if(n.some(e=>e&&(e.toString().toLowerCase().includes(`tổng cộng`)||e.toString().toLowerCase()===`cộng`)))break;let r=n[i]?.toString().trim();!r||r===``||/^[IVXLCDM]+\./.test(r)||r.split(` `).length<2&&isNaN(r)===!1||(r=r.replace(/\s*\([^)]+\)\s*$/,``),c.push({name:r,dept:o===-1?``:n[o]?.toString().trim(),amount:w(n[a]),content:s===-1?`Thưởng NĐ73`:n[s]?.toString().trim()}))}return c}async function j(){if(i[n]&&i[n].length>0){X();return}X();try{let t=k(await(await fetch(`https://corsproxy.io/?${encodeURIComponent(D(e))}`)).text());t.length&&(i[n]=t,S())}catch(e){console.error(e)}finally{X()}}var M=()=>`
  ...
  </div>`};function L(e){let t={};return[...new Set([...Object.keys(i),...Object.keys(a),...Object.keys(o)])].forEach(n=>{let r=parseInt(n.split(`/`)[0]);if(isNaN(r)||e!==`all`&&e!==(r<=3?`1`:r<=6?`2`:r<=9?`3`:`4`))return;let s={},c=e=>{if(e&&e.name&&C(e)){let t=e.name.replace(/\s+/g,` `).trim();s[t]||(s[t]={name:t,dept:e.department||e.dept||``})}};(i[n]||[]).forEach(c),(a[n]||[]).forEach(c),(o[n]||[]).forEach(c),Object.values(s).forEach(e=>{let r=e.name;t[r]||(t[r]={name:r,dept:e.dept,monthsInPeriod:0,rawAmounts:Array(19).fill(0),otAmount:0,bonusAmount:0,numDependents:l[r]===void 0?0:l[r],id:0}),t[r].monthsInPeriod+=1;let s=e=>(e||``).replace(/\s+/g,` `).trim().toLowerCase(),c=s(r),u=(i[n]||[]).find(e=>s(e.name)===c);u&&u.rawAmounts&&(u.id&&(t[r].id=parseInt(u.id)||t[r].id),u.rawAmounts.forEach((e,n)=>t[r].rawAmounts[n]=(t[r].rawAmounts[n]||0)+(e||0)),l[r]===void 0&&u.numDependents&&(t[r].numDependents=Math.max(t[r].numDependents,u.numDependents)));let d=(a[n]||[]).find(e=>s(e.name)===c);t[r].otAmount+=d?d.amount:0;let f=(o[n]||[]).find(e=>s(e.name)===c);t[r].bonusAmount+=f?f.amount:0})}),Object.values(t).map(e=>{let t=e.rawAmounts[8]+e.otAmount+e.bonusAmount,n=e.monthsInPeriod*b,r=e.monthsInPeriod*(e.numDependents*x),i=(e.rawAmounts[9]||0)+(e.rawAmounts[10]||0)+(e.rawAmounts[11]||0),a=t-i-n-r;return{...e,months:e.monthsInPeriod,gross_taxable:t,gt_bt:n,gt_npt:r,taxable:a,insurance:i}}).sort((e,t)=>(e.id||999999)-(t.id||999999))}var R=()=>{let e=[`Lương chính`,`PC vượt khung`,`PC Khu vực`,`PC Chức vụ`,`PC Trách nhiệm`,`PC ưu đãi ngành`,`PC Độc hại`,`PC cấp ủy`,`Tổng cộng lương`,`Khấu trừ 10,5% BH`,`KT 10,5% BH CV`,`KT 10,5% BH VK`,`Trừ ốm LC`,`Trừ ốm VK`,`Trừ ốm CV`,`Trừ ốm TN`,`Trừ ốm ƯĐ`,`Trừ ốm ĐH`,`Tổng lĩnh`],t=L(r),n=u?t.filter(e=>e.name.toLowerCase().includes(u.toLowerCase())):t;return`
  <div class="fade-in">
  ...
  </div>`},z=()=>{let e=[],t=``;if(d===`monthly`){let r=o[n]||[];e=u?r.filter(e=>e.name.toLowerCase().includes(u.toLowerCase())):r,t=`Danh sách Khen thưởng ${n}`}else{let n=P(f),r=N(o,n);e=u?r.filter(e=>e.name.toLowerCase().includes(u.toLowerCase())):r,t=`Tổng hợp Khen thưởng `+(f===`all`?`Cả năm`:`Quý `+f[1])}let r=E(Object.keys(o));return`
  <div class="fade-in">
    ${F(t)}
    <div class="card">
      <div style="display:flex;justify-content:space-between;margin-bottom:1.5rem;gap:1rem;flex-wrap:wrap;">
  ...
  </div>`},B=()=>{let e=[],t=``;if(d===`monthly`){let r=a[n]||[];e=u?r.filter(e=>e.name.toLowerCase().includes(u.toLowerCase())):r,t=`Trực & Ngoài giờ ${n}`}else{let n=P(f),r=N(a,n);e=u?r.filter(e=>e.name.toLowerCase().includes(u.toLowerCase())):r,t=`Tổng hợp Ngoài giờ `+(f===`all`?`Cả năm`:`Quý `+f[1])}let r=E(Object.keys(a));return`
  <div class="fade-in">
    ${F(t)}
    <div class="card">
      <div style="display:flex;justify-content:space-between;margin-bottom:1.5rem;gap:1rem;flex-wrap:wrap;">
  ...
  `,t=``;return m===`salary`?t=G():m===`coefficients`?t=K():m===`template`&&(t=q()),`
  <div class="fade-in">
    ${F(`Dự toán năm `+g)}
    <div class="card">
  ...
  `;let i=e.cloneNode(!0);i.style.width=`100%`,i.style.fontSize=`10px`,n.appendChild(i);let a={margin:[10,5,10,5],filename:`Thue_TNCN_${t.replace(` `,`_`)}.pdf`,image:{type:`jpeg`,quality:.98},html2canvas:{scale:2,useCORS:!0,letterRendering:!0},jsPDF:{unit:`mm`,format:`a4`,orientation:`landscape`}};html2pdf().set(a).from(n).save()},window.showReportPreview=function(e){let t=document.getElementById(`preview-modal`),c=document.getElementById(`preview-container`);if(!t||!c)return;let l=``,u=``,m=``,h=new Date,g=`Than Uyên, ngày ${h.getDate()} tháng ${h.getMonth()+1} năm ${h.getFullYear()}`;if(e===`salary`){let e=d===`summary`,t=e?f===`all`?`CẢ NĂM 2026`:`QUÝ ${f[1]}/2026`:`THÁNG ${n}`;l=`BẢNG ${e?`TỔNG HỢP`:`THANH TOÁN`} LƯƠNG NHÂN VIÊN`,u=t;let r=e?N(i,P(f)):(i[n]||[]).filter(C);m=`
    ...
    `}else if(e===`bonus`){let e=d===`summary`,t=e?f===`all`?`CẢ NĂM 2026`:`QUÝ ${f[1]}/2026`:`THÁNG ${n}`;l=`BẢNG TỔNG HỢP TIỀN KHEN THƯỞNG`,u=t;let r=e?P(f):[n],i={};r.forEach(e=>{(o[e]||[]).forEach(e=>{i[e.name]||(i[e.name]={...e,amount:0,months_count:0}),i[e.name].amount+=e.amount||0,i[e.name].months_count++})});let a=Object.values(i);m=`
      <table class="report-table">
        <thead>
          <tr>
            <th>TT</th><th>Họ và tên</th><th>Bộ phận</th>
    ...
    `}else if(e===`nq20`){let e=d===`summary`,t=e?f===`all`?`CẢ NĂM 2026`:`QUÝ ${f[1]}/2026`:`THÁNG ${n}`;l=`BẢNG TỔNG HỢP CHI TRẢ ĐÃI NGỘ NQ20`,u=t;let r=``,i=``,a=``;if(e){let e=P(f),t={};e.forEach(e=>{(s[e]||[]).forEach(e=>{t[e.name]||(t[e.name]={...e,amount:0,months_count:0}),t[e.name].amount+=e.amount||0,t[e.name].months_count+=e.months===void 0?1:e.months})});let n=Object.values(t);r=`<tr><th>TT</th><th>Họ và tên</th><th>Đối tượng</th><th>Đơn vị công tác</th><th>Số tháng hưởng</th><th>Tổng tiền hỗ trợ</th><th>Ghi chú</th></tr>`,i=n.map((e,t)=>`<tr>
        <td>${t+1}</td>
        <td>${e.name}</td>
    ...
    `}else if(e===`pit`){let e=r===`all`?`CẢ NĂM 2026`:`QUÝ ${r}/2026`;l=`BẢNG KÊ THU NHẬP TÍNH THUẾ THU NHẬP CÁ NHÂN`,u=e;let t=[`Lương chính`,`PC vượt khung`,`PC Khu vực`,`PC Chức vụ`,`PC Trách nhiệm`,`PC ưu đãi ngành`,`PC Độc hại`,`PC cấp ủy`,`Tổng lương`,`BH 10.5%`,`BH CV`,`BH VK`,`Trừ ốm LC`,`Trừ ốm VK`,`Trừ ốm CV`,`Trừ ốm TN`,`Trừ ốm ƯĐ`,`Trừ ốm ĐH`,`Thực lĩnh`],n=L(r);m=`
      <table class="report-table">
        <thead>
          <tr>
        ...
        <tbody>
          ${n.map(e=>`<tr>
              ...
              <td>${O(e.taxable>0?e.taxable:0)}</td>
            </tr>`).join(``)}
        </tbody>
      </table>
    `}c.innerHTML=`
